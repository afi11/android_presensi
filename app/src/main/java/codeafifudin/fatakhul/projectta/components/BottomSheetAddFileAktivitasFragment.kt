...
class BottomSheetAddFileAktivitasFragment : BottomSheetDialogFragment() {

    lateinit var thisParent : TambahAktivitasActivity
    lateinit var v : View
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        thisParent = activity as TambahAktivitasActivity
