...
class OpenFileIzinPenugasanActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "File Penugasan"
        ...
        urlFile = EndPoints.URL_FILE_TUGAS+intent.getStringExtra("openFile")
        ...
        PRDownloader.download(url, dirPath, fileName).build()
            .start(object : OnDownloadListener {
                ...
                override fun onError(error: Error?) {
                    Toast.makeText(
                        this@OpenFileIzinPenugasanActivity,
