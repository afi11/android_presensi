...
class OpenFileIzinActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "File Izin Pegawai"
        ...
        urlFile = EndPoints.URL_FILE_IZIN+intent.getStringExtra("openFile")
